...
<style>
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?> </span> di Dashboard Perpustakaan Satoe</div>
    ...
    <div class="mt-3 p-3">
      <div class="mt-2 mb-4">
       <h3 class="mb-3">Layanan Perpustakaan yang tersedia</h3>
        ...
        <div class="d-flex flex-wrap justify-content-center gap-4 mt-4">
  <a href="buku/daftarBuku.php" class="btn btn-primary p-4 text-center shadow-sm" style="width: 250px; border-radius: 10px;">
    <i class="fa-solid fa-book fa-2x mb-2"></i>
    <div class="fw-bold">Daftar Buku</div>
  </a>
  <a href="formPeminjaman/TransaksiPeminjaman.php" class="btn btn-success p-4 text-center shadow-sm" style="width: 250px; border-radius: 10px;">
    <i class="fa-solid fa-hand-holding fa-2x mb-2"></i>
    <div class="fw-bold">Peminjaman</div>
  </a>
  <a href="formPeminjaman/TransaksiPengembalian.php" class="btn btn-info p-4 text-center shadow-sm" style="width: 250px; border-radius: 10px;">
    <i class="fa-solid fa-rotate-left fa-2x mb-2"></i>
    <div class="fw-bold">Pengembalian</div>
  </a>
  <a href="formPeminjaman/TransaksiDenda.php" class="btn btn-danger p-4 text-center shadow-sm" style="width: 250px; border-radius: 10px;">
